...
public:
	...
	void operator=(const string& s);// Overload the assignment operator as a member function to take a string (C-style or C++ string, just be consistent in your implementation as an argument and assigns its value to A, the current object;
	...
	word* Search(const string& key);
private:
	word* front /*first*/, * back /*second*/;
	int count = 0;
};
#endif
